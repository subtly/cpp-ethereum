...
protected:
	...
	virtual Capability* newPeerCapability(std::shared_ptr<Session> const& _s, unsigned _idOffset) = 0;
...
protected:
	...
	Capability* newPeerCapability(std::shared_ptr<Session> const& _s, unsigned _idOffset) { return new PeerCap(_s, this, _idOffset); }
};
